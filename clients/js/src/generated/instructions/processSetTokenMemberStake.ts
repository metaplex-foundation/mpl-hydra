...
// Arguments.
export type ProcessSetTokenMemberStakeInstructionData = {
...
export function getProcessSetTokenMemberStakeInstructionDataSerializer(
  context: Pick<Context, 'serializer'>
): Serializer<
  ProcessSetTokenMemberStakeInstructionArgs,
  ProcessSetTokenMemberStakeInstructionData
> {
  ...
  return mapSerializer<
    ...
    ProcessSetTokenMemberStakeInstructionData
  >(
    s.struct<ProcessSetTokenMemberStakeInstructionData>(
      [
    ...
    (value) =>
      ...
      } as ProcessSetTokenMemberStakeInstructionData)
  ) as Serializer<
    ProcessSetTokenMemberStakeInstructionArgs,
    ProcessSetTokenMemberStakeInstructionData
  >;
...
// Instruction.
export function processSetTokenMemberStake(
  context: Pick<Context, 'serializer' | 'programs'>,
  input: ProcessSetTokenMemberStakeInstructionAccounts &
    ProcessSetTokenMemberStakeInstructionArgs
): WrappedInstruction {
  ...
  // Data.
  const data =
    getProcessSetTokenMemberStakeInstructionDataSerializer(context).serialize(
      input
    );
