...
# Devnet-only external program/account IDs to fetch. Hydra currently has none,
# but the script is kept so the build pipeline matches the other Metaplex repos.
EXTERNAL_ID=()
